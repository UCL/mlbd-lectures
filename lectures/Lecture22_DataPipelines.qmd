...
In this example we will use [the Python package `boto3`](https://boto3.amazonaws.com/v1/documentation/api/latest/index.html) which will allows to programmatically access data in a S3 bucket in Python - you will need to install this in your Python environment to run the code locally.
...
::: {.slides-only}
To run example locally, you will need to install [the Python package `boto3`](https://boto3.amazonaws.com/v1/documentation/api/latest/index.html).
:::
...
```{python}
#| echo: true
#| code-line-numbers: "1-2,5-6|3,7|4,8-10|11"
