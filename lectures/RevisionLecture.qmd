...
- and adding abstractions for thinking in terms of data workflows.
:::
...
_Structured Query Language_ (SQL) provides a standardized approach to extracting, joining,  aggregating and updating data in relational databases.
...
- How can we access Spark's capabilities programmatically?
