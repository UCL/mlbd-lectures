...
::: {.notes}
We're now in the final lecture for today where we will be continuing to explore data version control. This lecture will be a bit shorter than the other two so there should be time to answer any questions about all of the material today at the end or if you don't have any questions to head off for an earlier lunch.

Specifically in this lecture we will look at some more advanced features of DVC, namely
...
The `get-url` and `import-url` variants allow us the flexibility of working with non-Git based storage, with there built in support for a range of protocols and providers and an extensible interface for working with additional unsupported providers.
:::
...
::: {.notes}
In this last lecture we have explored
